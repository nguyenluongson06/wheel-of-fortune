        ...
        function (a, b, c) {
                ...
                (l.updateTo = function (a, b) {
                    ...
                    if (e._initted || g)
                        if (b) (e._initted = !1), g && e.render(0, !0, !0);
                            ...
                            ((e._initted = !1), e._init(), e._time > 0 || g)
                        )
                ...
                (l.render = function (a, b, d) {
                        ...
                        (a >= q - h && a >= 0
                            ? ((p._totalTime = q),
                              ...
                              0 === u &&
                                  ...
                                  (p._startTime === p._timeline._duration &&
                                      (a = 0),
                                  (0 > v ||
                                      (0 >= a && a >= -h) ||
                                      (v === h && 'isPause' !== p.data)) &&
                    ...
                    p._onUpdate &&
                        ...
                        p._cycle !== t &&
                            (b ||
                                p._gc ||
                                (p.vars.onRepeat && p._callback('onRepeat'))),
                        f &&
                            (!p._gc || d) &&
                            (0 > a &&
                                p._startAt &&
                                ...
                                p._startAt.render(a, !0, d),
                            e &&
                                (p._timeline.autoRemoveChildren &&
                                    p._enabled(!1, !1),
                                (p._active = !1)),
            ...
            var n = function (a, b) {
                ...
                o = (g.getAllTweens = function (b) {
                    return n(a._rootTimeline, b).concat(
                        n(a._rootFramesTimeline, b)
                    );
                });
            ...
            var p = function (a, c, d, e) {
                (c = c !== !1), (d = d !== !1), (e = e !== !1);
                for (
                    var f, g, h = o(e), i = c && d && e, j = h.length;
                    --j > -1;
                ...
                return (
                    ...
                    (s.add = function (e, f, g, h) {
                        ...
                        if (
                            ...
                            (e._time || (!e._duration && e._initted)) &&
                                ((j =
                                    (p.rawTime() - e._startTime) *
                                    e._timeScale),
                                (!e._duration ||
                                    Math.abs(
                                        Math.max(
                                            0,
                                            Math.min(e.totalDuration(), j)
                                        )
                                    ) -
                                        e._totalTime >
                                        1e-5) &&
                    ...
                    (s.render = function (a, b, c) {
                        ...
                        if ((o._time !== p && o._first) || c || i || l) {
                            ...
                            o._onUpdate &&
                                (b ||
                                    (j.length && k(), o._callback('onUpdate'))),
                                h &&
                                    (o._gc ||
                                        ((r === o._startTime ||
                                            s !== o._timeScale) &&
                ...
                return (
                    ...
                    (k.render = function (a, b, c) {
                        ...
                        var d,
                            ...
                            y = p._cycle;
                        if (
                            (q !== p._time && (a += p._time - q),
                            a >= r - e && a >= 0)
                        )
                            p._locked ||
                                ((p._totalTime = r), (p._cycle = p._repeat)),
                                p._reversed ||
                                    p._hasPausedChild() ||
                                    ((f = !0),
                                    (j = 'onComplete'),
                        ...
                        p._onUpdate &&
                            (b || (g.length && h(), p._callback('onUpdate'))),
                            j &&
                                (p._locked ||
                                    p._gc ||
                                    ((u === p._startTime ||
            ...
            function (a, b) {
                ...
                var k,
                    ...
                    V = (function () {
                        ...
                        return (
                            (m =
                                ...
                                -1 === U.indexOf('Chrome') &&
                                (-1 === a ||
                                    parseFloat(U.substr(a + 8, 2)) > 3)),
                            (o =
                                m &&
                                parseFloat(
                                    U.substr(U.indexOf('Version/') + 8, 2)
                                ) < 6),
                    ...
                    ia = function (a, b, c) {
                        ...
                        for (c = c || aa(a, null); --f > -1; )
                            (d -=
                                parseFloat(ba(a, 'padding' + e[f], c, !0)) ||
                                0),
                                (d -=
                                    parseFloat(
                                        ba(a, 'border' + e[f] + 'Width', c, !0)
                                    ) || 0);
                        return d;
                    },
                    ja = function (a, b) {
                ...
                (j = g.prototype),
                    ...
                    (j._enableTransforms = function (a) {
                        (this._transform =
                            this._transform || Ta(this._target, e, !0)),
                            (this._transformType =
            ...
            _ = (S.lazyRender = function () {
                ...
                for (L = {}, a = 0; c > a; a++)
                    (b = K[a]),
                        b &&
                            b._lazy !== !1 &&
                            (b.render(b._lazy[0], b._lazy[1], !0),
                            (b._lazy = !1));
                K.length = 0;
            });
        (Z._startTime = j.time),
            ...
            (E._updateRoot = H.render =
                function () {
                    ...
                    if (
                        (K.length && _(),
                        Z.render(
                            (j.time - Z._startTime) * Z._timeScale,
                            !1,
                            !1
                        ),
                        Y.render(
                            (j.frame - Y._startTime) * Y._timeScale,
                            !1,
                            !1
                        ),
                        K.length && _(),
                            ...
                            : 0 > a &&
                              ...
                              0 === j &&
                                  ...
                                  (h._rawPrevTime = g =
                                      !b || a || k === a ? a : n))),
                        (!h._initted ||
                            (h._startAt && h._startAt.progress())) &&
                            (c = !0);
